...
from account_post.models import EmailAddress_post
from account_post.utils import get_user_lookup_kwargs
...
class SignupForm(forms.Form):
    ...
    password = PasswordField(
        label=_("Password"),
        strip=settings.ACCOUNT_POST_PASSWORD_STRIP,
    )
...
class SettingsForm(forms.Form):
    ...
    timezone = forms.ChoiceField(
        label=_("Timezone"),
        choices=[("", "---------")] + settings.ACCOUNT_POST_TIMEZONES,
        required=False
    )
