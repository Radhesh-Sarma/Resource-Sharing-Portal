...
import pytz
from account_post import signals
from account_post.conf import settings
from account_post.fields import TimeZoneField
from account_post.hooks import hookset
from account_post.languages import DEFAULT_LANGUAGE
from account_post.managers import EmailAddressManager, EmailConfirmationManager
from account_post.signals import signup_code_sent, signup_code_used
...
class Account(models.Model):
    ...
    language = models.CharField(
        _("language"),
        max_length=10,
        choices=settings.ACCOUNT_POST_LANGUAGES,
...
class EmailAddress_post(models.Model):

    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    email = models.EmailField(max_length=254, unique=settings.ACCOUNT_POST_EMAIL_UNIQUE)
    ...
    class Meta:
        ...
        if not settings.ACCOUNT_POST_EMAIL_UNIQUE:
...
class EmailConfirmation(models.Model):
    ...
    email_address = models.ForeignKey(EmailAddress_post, on_delete=models.CASCADE)
